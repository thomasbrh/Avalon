...
export default class ItemViewerManager
{
    constructor()
    {
        ...
        this.loader = document.querySelector('.item-viewer__loader')
    ...
    async open(journalElement)
    {
        ...
        const model = await this.loadModel(journalElement)

        if(!this.isOpen || currentRequest !== this.requestId) return
